package com.xmcc.mll_miaosha.util;
...
/**
 * 该工具类，是所有的key都是字符串的情况下，如果在实际中有其他类型作为key，
 * 只需要将方法的key改为Object然后在工具类中调用Object转Json字符串的方法就可以了
 */
@Component
@Slf4j
public class RedisUtils {
    ...
    /*****String数据类型方法   opsForValue表示是操作字符串类型*****/
